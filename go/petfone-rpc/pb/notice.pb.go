...
func (*NoticeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_notice_9d26f73a5f8fb61f, []int{0}
}
...
func (*NoticeReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_notice_9d26f73a5f8fb61f, []int{1}
}
...
func (*NoticeMapRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_notice_9d26f73a5f8fb61f, []int{2}
}
...
func (*NoticeMapReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_notice_9d26f73a5f8fb61f, []int{3}
}
...
func init() { proto.RegisterFile("pb/notice.proto", fileDescriptor_notice_9d26f73a5f8fb61f) }

var fileDescriptor_notice_9d26f73a5f8fb61f = []byte{
