...
It has these top-level messages:
	...
	SetUpgradeResponse
	UpgradeCategory
	UpgrageCategoryResponse
	GetUpgradeCategoryRequest
	GetUpgradeCategoryResponse
	GetUpgradeInfosRequest
	UpgradeInfo
	GetUpgradeInfosResponse
	DeleteUpgradeInfoRequest
	DeleteUpgradeInfoResponse
	UpdateUpgradeInfoRequest
	UpdataUpgradeInfoResponse
	NodeAdv
	NodeAdvInfoRequest
	NodeAdvInfoResponse
*/
