...
Contains some code from Golang's httpReq.ServeFile method, and
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "httpReq://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">
<html xmlns="httpReq://www.w3.org/1999/xhtml" xml:lang="en">
...
<thead><tr><th class="n">名称</th><th class="t">类型</th><th class="dl">选择</th></tr></thead>
<tbody>
<tr><td class="n"><a href="../">返回</a>/</td><td class="t">目录</td><td class="dl"></td></tr>
{{range .Children_dir}}
<tr><td class="n"><a href="{{.}}/">{{.}}/</a></td><td class="t">文件夹</td><td class="dl"></td></tr>
{{end}}
{{range .Children_files}}
<tr><td class="n"><a href="{{.}}">{{.}}</a></td><td class="t">&nbsp;</td><td class="dl"><a href="{{.}}?dl">下载</a></td></tr>
{{end}}
</tbody>
</table>
</div>
