...
const AssetIDNode = 1
const ProductIDNode = 2
const DataPointIDNode = 3

func GetAssetID() (id int64, err error) {
	node, err := NewNode(AssetIDNode)
	if err != nil {
		return
	}
...
func GetProductID() (id int64, err error) {
	node, err := NewNode(ProductIDNode)
	if err != nil {
		return
	}
	id = node.Generate().Int64()
...
func GetDataPointID() (id int64, err error) {
	node, err := NewNode(DataPointIDNode)
	if err != nil {
		return
	}
	id = node.Generate().Int64()
