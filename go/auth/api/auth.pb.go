...
It has these top-level messages:
	...
	GetUserCountInTenantRequest
	GetUserCountInTenantResponse
	GetUserInfoInTenantRequest
	GetUserInfoInTenantResponse
	UpdateUserRoleInTenantRequest
	UpdateUserRoleInTenantResponse
	DeleteUserInTenantRequest
	DeleteUserInTenantResponse
	AddUserInTenantRequest
	AddUserInTenantResponse
	EnterTenantRequest
	EnterTenantResponse
	GetTidByUrlRequest
	GetTidByUrlResponse
	GetDidByTidRequest
	GetDidByTidResponse
	InviteUnactivatedTenantRequest
	InviteUnactivatedTenantResponse
	RoleInfo
	Module
	ModuleInfo
	RoleModules
	...
	DeleteRoleRequest
	DeleteRoleResponse
	GetModuleByTidRequest
	GetModuleByTidResponse
	GetModuleByDidRequest
	GetModuleByDidResponse
	GetRoleByRidRequest
	GetRoleByRidResponse
	Resource
	GetResourcesRequest
	...
	UpdateNicknameAndPasswordRequest
	UpdateNicknameAndPasswordResponse
	...
	GetUserCountInDomainRequest
	GetUserCountInDomainResponse
	GetDomainsRequest
	GetDomainsResponse
	GetUserInfoInDomainRequest
	GetUserInfoInDomainResponse
	UpdateUserRoleInDomainRequest
	UpdateUserRoleInDomainResponse
	DeleteUserInDomainRequest
	DeleteUserInDomainResponse
	AddUserInDomainRequest
	AddUserInDomainResponse
	EnterDomainRequest
	EnterDomainResponse
	AddUserTenantACLRequest
	AddUserTenantACLResponse
	ActionLogInfo
	AddActionLogRequest
	AddActionLogResponse
	GetActionLogsByTypeRequest
	GetActionLogsByTypeResponse
	GetActionLogsByUsernameRequest
	GetActionLogsByUsernameResponse
	GetActionLogsByRoleRequest
	GetActionLogsByRoleResponse
	GetActionLogsRequest
	GetActionLogsResponse
	GetActionLogsByTidRequest
	GetActionLogsByTidResponse
	GetActionLogsByDidRequest
	GetActionLogsByDidResponse
	Service
	AddServiceRequest
	AddServiceResponse
	...
	GetServiceBySidRequest
	GetServiceBySidResponse
	GetServiceByTidRequest
	GetServiceByTidResponse
	Policy
	AddPolicyRequest
	AddPolicyResponse
	DeletePolicyByPidRequest
	DeletePolicyByPidResponse
	DeletePolicyBySidRequest
	DeletePolicyBySidResponse
	UpdatePolicyRequest
	UpdatePolicyResponse
	GetPolicyByPidRequest
	GetPolicyByPidResponse
	GetPolicyBySidRequest
	GetPolicyBySidResponse
	AliPay
	WechatPay
	AddAliPayRequest
	AddAliPayResponse
	DeleteAliPayRequest
	DeleteAliPayResponse
	UpdateAliPayRequest
	UpdateAliPayResponse
	GetAliPayRequest
	GetAliPayResponse
	AddWechatPayRequest
	AddWechatPayResponse
	DeleteWechatPayRequest
	DeleteWechatPayResponse
	UpdateWechatPayRequest
	UpdateWechatPayResponse
	GetWechatPayRequest
	GetWechatPayResponse
	TradingRecord
	GetTenantAccountRequest
	GetTenantAccountResponse
	UpdateTenantAccountRequest
	UpdateTenantAccountResponse
	GetTradingRecordsRequest
	GetTradingRecordsResponse
*/
package api
...
type Tenant struct {
	...
	Oid          int32         `protobuf:"varint,10,opt,name=Oid" json:"Oid,omitempty"`
}
