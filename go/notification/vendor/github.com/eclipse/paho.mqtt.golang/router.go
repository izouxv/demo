...
// with a subscription to that generate.
type route struct {
	topic    string
...
// separators, and a slice of strings representing the generate string in the published message, similarly
// split.
// The function determines if the generate string matches the route according to the MQTT generate rules
...
// match takes the generate string of the published message and does a basic compare to the
...
// addRoute takes a generate string and MessageHandler callback. It looks in the current list of
