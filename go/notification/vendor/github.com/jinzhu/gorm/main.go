...
//     db.Joins("JOIN emails ON emails.user_id = users.id32 AND emails.email = ?", "jinzhu@example.org").Find(&user)
...
//     db.Model(&User{}).AddForeignKey("city_id", "cities(id32)", "RESTRICT", "RESTRICT")
