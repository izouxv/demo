...
@javax.annotation.Generated(
    ...
    comments = "Source: twins-agent.proto")
public class TwinsAgentServerGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.lanlian.rpc.twins.AddTwinsAgentRequest,
      com.lanlian.rpc.twins.AddTwinsAgentResponse> METHOD_ADD_TWINS_AGENT =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "agent.TwinsAgentServer", "AddTwinsAgent"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.lanlian.rpc.twins.AddTwinsAgentRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.lanlian.rpc.twins.AddTwinsAgentResponse.getDefaultInstance()));
   ...
   */
  public static TwinsAgentServerBlockingStub newBlockingStub(
   ...
   */
  public static TwinsAgentServerFutureStub newFutureStub(
      io.grpc.Channel channel) {
  ...
  public static abstract class TwinsAgentServerImplBase implements io.grpc.BindableService {
    ...
    @java.lang.Override public io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            METHOD_ADD_TWINS_AGENT,
            asyncUnaryCall(
              new MethodHandlers<
                com.lanlian.rpc.twins.AddTwinsAgentRequest,
                com.lanlian.rpc.twins.AddTwinsAgentResponse>(
  ...
  public static final class TwinsAgentServerStub extends io.grpc.stub.AbstractStub<TwinsAgentServerStub> {
    ...
    @java.lang.Override
    protected TwinsAgentServerStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
    ...
    public void addTwinsAgent(com.lanlian.rpc.twins.AddTwinsAgentRequest request,
        io.grpc.stub.StreamObserver<com.lanlian.rpc.twins.AddTwinsAgentResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_ADD_TWINS_AGENT, getCallOptions()), request, responseObserver);
    }
  }

  /**
   */
  public static final class TwinsAgentServerBlockingStub extends io.grpc.stub.AbstractStub<TwinsAgentServerBlockingStub> {
    ...
    @java.lang.Override
    protected TwinsAgentServerBlockingStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
     ...
     * </pre>
     */
    public com.lanlian.rpc.twins.AddTwinsAgentResponse addTwinsAgent(com.lanlian.rpc.twins.AddTwinsAgentRequest request) {
      return blockingUnaryCall(
          getChannel(), METHOD_ADD_TWINS_AGENT, getCallOptions(), request);
    }
  }
  ...
  public static final class TwinsAgentServerFutureStub extends io.grpc.stub.AbstractStub<TwinsAgentServerFutureStub> {
    ...
    @java.lang.Override
    protected TwinsAgentServerFutureStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.lanlian.rpc.twins.AddTwinsAgentResponse> addTwinsAgent(
      ...
      return futureUnaryCall(
          getChannel().newCall(METHOD_ADD_TWINS_AGENT, getCallOptions()), request);
    }
  }
