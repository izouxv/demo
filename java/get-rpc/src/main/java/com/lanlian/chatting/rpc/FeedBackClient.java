...
//	
//	private static Logger log = Logger.getLogger(FeedBackClient.class);
//
//	/**
...
//	 * @param statis
//	 */
//	public int addFeedBack(String source, String description,String mobileInfo, String appInfo, String deviceInfo, 
...
//			builder.clear();
//			log.info("addFeedBack-request:" + request);
//			AddFeedbackReply rpcReply = feedbackBlockingStub.addFeedback(request);
//			log.info("addFeedBack-rpcReply:" + rpcReply);
//			return rpcReply.getId();
//		} catch (Exception e) {
//			log.error(e);
//			return 0;
//		}
...
//		clientRpc.addFeedBack("AQIDAA==", "test", "", "test", ""," test", "", new String[]{""}, "");
//		clientRpc.shutdown();
//	}
//
//}
