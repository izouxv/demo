...
public class SsoClient {
	 ...
	 */
	public SsoPo sendMobileCode(SsoPo ssoPo, int action) {
		...
		builder.clear();
		logger.info("RPC-request-sendMobileCode:" + request);
		SsoReply ssoReply = ssoBlockingStub.sendMobileCode(request);
		logger.info("RPC-ssoReply-sendMobileCode:" + ssoReply);
	 ...
	 * @throws Parameter_Exception
	 */
	public SsoPo sendMobile(SsoPo ssoPo) {
		Builder builder = getBuilder();
		builder.setUsername(ssoPo.getUsername());
		builder.setSource(ssoPo.getSource());
	...
	public void verifyMobileCode(String username, String code, int action, String source) throws Parameter_Exception {
		...
		SsoRequest request = builder.build();
		builder.clear();
		logger.info("RPC-request-verifyMobileCode:" + request);
	 ...
	 * @throws Parameter_Exception
	 */
	public SsoPo getUserByName(SsoPo ssoPo) {
		Builder builder = getBuilder();
		builder.setSource(ssoPo.getSource());
		builder.setUsername(ssoPo.getUsername());
		SsoRequest request = builder.build();
		builder.clear();
		logger.info("SsoRPC-request-getUserByName:" + request);
		SsoReply ssoReply = ssoBlockingStub.getUserByName(request);
		logger.info("SsoRPC-ssoReply-getUserByName:" + ssoReply);
		BeanUtils.copyProperties(ssoReply, ssoPo);
		return ssoPo;
	}
	...
	public SsoPo add(SsoPo ssoPo) {
		...
		SsoRequest request = builder.build();
		builder.clear();
		logger.info("ssoPo-add-RPC:" + request);
		SsoReply ssoReply = ssoBlockingStub.add(request);
		logger.info("ssoReply-add-RPC:" + ssoReply);
	 ...
	 * @throws Parameter_Exception
	 */
	public SsoPo login(SsoPo ssoPo) {
		Builder builder = getBuilder();
		builder.setSource(ssoPo.getSource());
		builder.setUsername(ssoPo.getUsername());
		builder.setPassword(ssoPo.getPassword());
		...
		SsoRequest request = builder.build();
		builder.clear();
		logger.info("ssoPo-login-RPC:" + request);
		SsoReply ssoReply = ssoBlockingStub.login(request);
		logger.info("ssoReply-login-RPC:" + ssoReply);
		BeanUtils.copyProperties(ssoReply, ssoPo);
		return ssoPo;
	}
	 ...
	 * @throws Parameter_Exception
	 */
	public SsoPo logout(SsoPo ssoPo) {
		Builder builder = getBuilder();
		builder.setSource(ssoPo.getSource());
		builder.setSessionName(ssoPo.getSessionName());
		SsoRequest request = builder.build();
		builder.clear();
		logger.info("ssoPo-logout-RPC:" + request);
		SsoReply ssoReply = ssoBlockingStub.logout(request);
		logger.info("ssoReply-logout-RPC:" + ssoReply);
		BeanUtils.copyProperties(ssoReply, ssoPo);
		return ssoPo;
	}
	 ...
	 * @throws Parameter_Exception
	 */
	public SsoPo checkPassword(SsoPo ssoPo) {
		Builder builder = getBuilder();
		builder.setSource(ssoPo.getSource());
		...
		SsoRequest request = builder.build();
		builder.clear();
		logger.info("ssoPo-checkPassword-RPC:" + request);
		SsoReply ssoReply = ssoBlockingStub.checkPassword(request);
		logger.info("ssoReply-checkPassword-RPC:" + ssoReply);
		ssoPo.setErrorCode(ssoReply.getErrorCode());
		return ssoPo;
	}
	 ...
	 * @throws Parameter_Exception
	 */
	public SsoPo updatePassword(SsoPo ssoPo) {
		Builder builder = getBuilder();
		builder.setSource(ssoPo.getSource());
		builder.setUid(ssoPo.getUid());
		builder.setPassword(ssoPo.getPassword());
		...
		SsoRequest request = builder.build();
		builder.clear();
		logger.info("ssoPo-updatePassword-RPC:" + request);
		SsoReply ssoReply = ssoBlockingStub.updatePassword(request);
		logger.info("ssoReply-updatePassword-RPC:" + ssoReply);
		ssoPo.setErrorCode(ssoReply.getErrorCode());
		return ssoPo;
	}
	 ...
	 * @throws Parameter_Exception
	 */
	public SsoPo updatePasswordByName(SsoPo ssoPo) {
		Builder builder = getBuilder();
		builder.setSource(ssoPo.getSource());
		builder.setUsername(ssoPo.getUsername());
		builder.setPassword(ssoPo.getPassword());
		...
		SsoRequest request = builder.build();
		builder.clear();
		logger.info("ssoPo-updatePasswordByName-RPC:" + request);
		SsoReply ssoReply = ssoBlockingStub.updatePasswordByName(request);
		logger.info("ssoReply-updatePasswordByName-RPC:" + ssoReply);
		BeanUtils.copyProperties(ssoReply, ssoPo);
		return ssoPo;
	}
	 ...
	 * @throws Parameter_Exception
	 */
	public SsoPo getSsoInfo(SsoPo ssoPo) {
		Builder builder = getBuilder();
		builder.setSource(ssoPo.getSource());
		builder.setSessionName(ssoPo.getSessionName());
		SsoRequest request = builder.build();
		builder.clear();
		logger.info("session-getSsoInfo:" + request);
		SsoReply ssoReply = ssoBlockingStub.getUserInfo(request);
		logger.info("ssoReply-getSsoInfo:" + ssoReply);
	...
	public List<Integer> getBatchSsoInfos(List<Integer> uids, String source) throws Parameter_Exception {
		...
		builders.clear();
		logger.info("request-getBatchSsoInfos-RPC:" + request);
		MapSsoReply ssoReplyMap = ssoBlockingStub.getBatchSsoInfos(requests);
		logger.info("ssoReplyMap-getBatchSsoInfos-RPC:" + ssoReplyMap);
	 ...
	 * @throws Parameter_Exception
	 */
	public SsoPo sendEmail(SsoPo ssoPo) {
		Builder builder = getBuilder();
		builder.setSource(ssoPo.getSource());
		builder.setUsername(ssoPo.getUsername());
		SsoRequest request = builder.build();
		...
		logger.info("sendEmail-getSsoInfo:" + ssoReply);
		ssoPo.setErrorCode(ssoReply.getErrorCode());
		return ssoPo;
	}
