...
public class GroupSettingsController extends MyAbstractController {

	private static Logger log = Logger.getLogger(FilesController.class);

	@Resource
	@Qualifier("groupSettingsServiceImpl")
	...
	public String groupSync(@RequestParam(value = "uid", required = true) int uid,
