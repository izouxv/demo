...
public class AccountClient {
	 ...
	 */
	public AccountPo getUserInfo(AccountPo accountPo) {
	 ...
	 * @throws Parameter_Exception
	 */
	public AccountPo addAccountInfo(AccountPo accountPo) {
		Builder builder = getBuilder();
	 ...
	 * @throws Parameter_Exception
	 */
	public AccountPo updateExInfo(AccountPo accountPo) {
		Builder builder = getBuilder();
		builder = AccountRequest.newBuilder();
		builder.setSource(accountPo.getSource());
		builder.setUid(accountPo.getUid());
	 ...
	 * @throws Parameter_Exception
	 */
	public AccountPo updateAccountInfo(AccountPo accountPo) {
		Builder builder = getBuilder();
		builder = AccountRequest.newBuilder();
		builder.setSource(accountPo.getSource());
		builder.setUid(accountPo.getUid());
	 ...
	 * @throws Parameter_Exception
	 */
	public AccountPo getCertification(AccountPo accountPo) {
		Builder builder = getBuilder();
		builder = AccountRequest.newBuilder();
		builder.setSource(accountPo.getSource());
		builder.setUid(accountPo.getUid());
	 ...
	 * @throws Parameter_Exception
	 */
	public AccountPo updateCertification(AccountPo accountPo) {
		Builder builder = getBuilder();
		builder = AccountRequest.newBuilder();
		builder.setSource(accountPo.getSource());
		builder.setUid(accountPo.getUid());
