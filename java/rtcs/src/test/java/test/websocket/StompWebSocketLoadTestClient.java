...
public class StompWebSocketLoadTestClient {
	...
	public static void main(String[] args) throws Exception {
		...
		String homeUrl = "http://192.168.1.69:8080/rtcs";
		...
		try {
			...
			String stompUrl = "ws://192.168.1.69:8080/rtcs";
	...
	static class ConsumerStompSessionHandler extends StompSessionHandlerAdapter {
