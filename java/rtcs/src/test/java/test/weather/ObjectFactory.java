 ...
 * generated in the test.weather package. 
...
public class ObjectFactory {
    ...
    private final static QName DATASET_QNAME = new QName("http://WebXml.com.cn/", "DataSet");
    private final static QName ARRAYOFSTRING_QNAME = new QName("http://WebXml.com.cn/", "ArrayOfString");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: test.weather
     * 
     */
    ...
    public JAXBElement<DataSet> createDataSet(DataSet value) {
        return new JAXBElement<DataSet>(DATASET_QNAME, DataSet.class, null, value);
    }
    ...
    public JAXBElement<ArrayOfString> createArrayOfString(ArrayOfString value) {
        return new JAXBElement<ArrayOfString>(ARRAYOFSTRING_QNAME, ArrayOfString.class, null, value);
    }
