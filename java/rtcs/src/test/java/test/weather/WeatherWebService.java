 ...
 * 
 */
@WebServiceClient(name = "WeatherWebService", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/E:/weather.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/E:/weather.xml");
    ...
    public WeatherWebService() {
        super(getWsdlLocation(), WEATHERWEBSERVICE_QNAME);
    }

    public WeatherWebService(WebServiceFeature... features) {
        super(getWsdlLocation(), WEATHERWEBSERVICE_QNAME, features);
    }
